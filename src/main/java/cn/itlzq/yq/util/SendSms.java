...
public class SendSms {
    ...
    public static boolean send(String phoneNumber,String code) {
        DefaultProfile profile = DefaultProfile.getProfile("cn-hangzhou", "LTAI4Fg2DUUuR7SLQFK9AZqh", "Ir6aKrmFQeJvvc7zUFLRmzoplW05B5");
        ...
        request.putQueryParameter("SignName", "ithouse");
        request.putQueryParameter("TemplateCode", "SMS_183265838");
        //json格式
