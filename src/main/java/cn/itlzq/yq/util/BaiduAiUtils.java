...
public class BaiduAiUtils {
        ...
        //需要修改为自己的
        private static final String AppID = "19667161";
        private static final String APIKey = "hLR4H46EZOSTpPq0zViKkSdo";
        private static final String SecretKey = "um6HModyNbkY3Q5GZlBN3BWk7d0e7gQM";
        ...
        public static void main(String[] args) throws IOException {
            ...
            String file1 = "C:\\Users\\Qing\\Pictures\\Saved Pictures\\lzq.jpg";
            byte[] img2 = FileToByte(new File(file1));
            //String s = detectFace(new File(file1), "1");
            String s = searchFace(img2, "note",null);
     ...
     * 人脸检测
     */
    public static String detectFace(String base64, String max_face_num) {
        try {
         ...
         * @return
         */
        public static String searchFace(File file, String groupId, String userId) {
            try {
                return searchFace(FileToByte(file), groupId, userId);
            } catch (IOException e) {
     ...
     * @return
     */
    public static String searchFace(String base64, String groupIdList,
                                    String userId) {
        String imageType = "BASE64";
        HashMap<String, String> options = new HashMap<String, String>();
        options.put("quality_control", "NORMAL");
        ...
        options.put("max_user_num", "1");
        JSONObject res = client.search(base64, imageType, groupIdList, options);
        return res.toString(2);
    }
     ...
     * @return
     */
    public static String addUser(String base64,String userId,String groupId) {
        String imageType = "BASE64";
        HashMap<String, String> options = new HashMap<String, String>();
        options.put("quality_control", "NORMAL");
        options.put("liveness_control", "LOW");
        JSONObject res = client.addUser(base64, imageType, groupId, userId,options);
        return res.toString(2);
    }
